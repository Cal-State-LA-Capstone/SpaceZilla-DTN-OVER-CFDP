...
class GlobalSettings:
    ...
    ``host_mount_consent`` gates the container's read-only bind mount of
    the host root. The Node Picker / main-window flow writes this via
    :func:`store.save_settings` after the one-time consent prompt.
    """

    theme: str = "default"
    log_level: str = "INFO"
    host_mount_consent: bool = False
    host_mount_consent_at: str | None = None  # ISO-8601 timestamp
